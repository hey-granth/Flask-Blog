...
# It is just something that has to be done, specified in the documentation also.
...
class User(db.Model, UserMixin):
    ...
    # This method is used to generate a token for the user to reset their password.
    def get_reset_token(self):
        s = Serializer(current_app.config["SECRET_KEY"])
        return s.dumps({"user_id": self.id})

    # This method is used to verify the token generated by the get_reset_token method.
    @staticmethod
