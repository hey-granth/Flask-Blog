...
app = Flask(__name__)
app.config["SECRET_KEY"] = "5791628bb0b13ce0c676dfde280ba245" # This is the secret key for the app
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///site.db" # This is the path to the database
...
login_manager.login_view = "login" # this is the function name of the route for the login page
login_manager.login_message_category = "info" # bootstrap class for the message (nicely coloured blue thingy)
app.config["MAIL_SERVER"] = "smtp.googlemail.com" # smtp is a protocol for sending emails
